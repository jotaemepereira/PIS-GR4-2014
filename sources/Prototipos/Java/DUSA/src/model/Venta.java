...
public class Venta implements Serializable {
	...
	String serial;
	String formaDePago;
	BigDecimal montoNoGravado = new BigDecimal(0);
	BigDecimal montoNetoGravadoIvaMinimo = new BigDecimal(0);
	BigDecimal montoNetoGravadoIvaBasico = new BigDecimal(0);
	BigDecimal totalIvaMinimo = new BigDecimal(0);
	BigDecimal totalIvaBasico = new BigDecimal(0);
	BigDecimal montoTotal = new BigDecimal(0);
	BigDecimal montoRetenidoIVA = new BigDecimal(0);
	BigDecimal montoRetenidoIRAE = new BigDecimal(0);
	BigDecimal montoNoFacturable = new BigDecimal(0);
	BigDecimal montoTributoIvaMinimo = new BigDecimal(0);
	BigDecimal montoTributoIvaBasico = new BigDecimal(0);
	BigDecimal montoTotalAPagar = new BigDecimal(0);
	int cantidadLineas;
